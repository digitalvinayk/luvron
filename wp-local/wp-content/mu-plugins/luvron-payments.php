...
// Wrap gateway classes in plugins_loaded — mu-plugins fire BEFORE WooCommerce
// loads its WC_Payment_Gateway base class, so any extends WC_Payment_Gateway
// at file-load time fatals. Defer to plugins_loaded priority 11 (after WC).
...
}, 11); // Close plugins_loaded — gateway classes now defined safely AFTER WC loaded
